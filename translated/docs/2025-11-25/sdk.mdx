---
title: SDK
description: 用于构建模型上下文协议的官方 SDK
---

使用我们的官方 SDK 构建 MCP 服务器和客户端。SDK 根据特性完整度、协议支持和维护承诺被划分为不同等级（tier）。进一步了解 [SDK 等级](/community/sdk-tiers)。
...
有关每个等级含义的详情，参见 [SDK 分级体系](/community/sdk-tiers)。
